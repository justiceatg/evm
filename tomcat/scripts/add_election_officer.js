...
function addElectionOfficerFunction() {
    ...
    if (encodedFullnames === '' || encodedNationalId === '' || encodedElectionId === '') {
        ...
        // /addElectionOfficer/{session}/{fullnames}/{nationalId}/{election}
        var url = '/rest/api/addElectionOfficer/'
                + sessionId + '/'
                + encodedFullnames + '/'
                + encodedNationalId + '/'
                + encodedElectionId;
    ...
    $.ajax({
        ...
        success: function (data, status) {
            ...
            toastr["success"]("Election officer  was added to the database! ", "Success!")
        ...
        error: function (data, status) {
            ...
            toastr["error"]("Election officer was not added to the database! ", "Success!")
